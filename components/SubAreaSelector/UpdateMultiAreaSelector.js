...
export default function UpdateMultiSelectSubArea({
  propFormState,
  propSetFormState,
  propEditMode,
  propFieldName,
  ...
  return (
    <div className="col-sm-12">
      <div className="row mb-3 mt-1">
          ...
          <div className="col-md-6 col-sm-12">
            <div className="form-group">
              ...
              <Select
                ...
                value={areas.find((item) => item.value === selectedRow.AREA_ID)}
                styles={colourStyles}
                theme={customTheme}
              />
            </div>
        ...
        {selectedRow.CITY_ID !== "" && selectedRow.AREA_ID !== "" && (
          <div className="col-md-6 col-sm-12">
            <div className="form-group">
              <label
                id="lblSubArea"
