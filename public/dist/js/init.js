...
var elmer = function(){
	...
	$(document).on("keypress","#add_todo",function (e) {
		if ((e.which == 13)&&(!$(this).val().length == 0))  {
				$('<li className="todo-item"><div className="checkbox checkbox-success"><input type="checkbox" id="checkbox'+random+'"/><label for="checkbox'+random+'">' + $('.new-todo input').val() + '</label></div></li><li><hr className="light-grey-hr"/></li>').insertAfter(".todo-list li:last-child");
				$('.new-todo input').val('');
		} else if(e.which == 13) {
	...
	$(document).on("keypress","#input_msg_send",function (e) {
		if ((e.which == 13)&&(!$(this).val().length == 0)) {
			$('<li className="self mb-1"><div className="self-msg-wrap"><div className="msg block pull-right">' + $(this).val() + '<div className="msg-per-detail mt-5"><span className="msg-time txt-grey">3:30 pm</span></div></div></div><div className="clearfix"></div></li>').insertAfter(".fixed-sidebar-right .chat-content  ul li:last-child");
			$(this).val('');
		} else if(e.which == 13) {
			alert('Please type somthing!');
		}
	...
	$(document).on("keypress","#input_msg_send_widget",function (e) {
		if ((e.which == 13)&&(!$(this).val().length == 0)) {
			$('<li className="self mb-1"><div className="self-msg-wrap"><div className="msg block pull-right">' + $(this).val() + '<div className="msg-per-detail mt-5"><span className="msg-time txt-grey">3:30 pm</span></div></div></div><div className="clearfix"></div></li>').insertAfter(".chat-for-widgets .chat-content  ul li:last-child");
			$(this).val('');
		} else if(e.which == 13) {
			alert('Please type somthing!');
		}
	...
	$(document).on("keypress","#input_msg_send_chatapp",function (e) {
		if ((e.which == 13)&&(!$(this).val().length == 0)) {
			$('<li className="self mb-1"><div className="self-msg-wrap"><div className="msg block pull-right">' + $(this).val() + '<div className="msg-per-detail mt-5"><span className="msg-time txt-grey">3:30 pm</span></div></div></div><div className="clearfix"></div></li>').insertAfter(".chat-for-widgets-1 .chat-content  ul li:last-child");
			$(this).val('');
		} else if(e.which == 13) {
	...
	var $owl = $('.product-carousel').owlCarousel({
		...
		margin:15,
		nav:true,
		navText: ["<i className='zmdi zmdi-chevron-left'></i>","<i className='zmdi zmdi-chevron-right'></i>"],
		dots:false,
		autoplay:true,
		responsive:{
			0:{
