...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.structure = function() {
        ...
        if (this.s.controls && this.$items.length > 1) {
            controls = '<div className="lg-actions">' +
                '<div className="lg-prev lg-icon">' + this.s.prevHtml + '</div>' +
                '<div className="lg-next lg-icon">' + this.s.nextHtml + '</div>' +
                '</div>';
        }
        ...
        // add className lg-current to remove initial transition
        this.$slide.eq(this.index).addClass('lg-current');

        // add className for css support and transition mode
        if (this.doCss()) {
    ...
    Plugin.prototype.addHtml = function(index) {
        ...
        // Add lg-empty-html className if title doesn't exist
        if (typeof subHtml !== 'undefined' && subHtml !== null) {
            if (subHtml === '') {
     ...
     *  @param {Boolean} delay - delay for adding complete className. it is 0 except first time.
     */
    Plugin.prototype.loadContent = function(index, rec, delay) {
        ...
        if (!_this.$slide.eq(index).hasClass('lg-loaded')) {
            if (iframe) {
                _this.$slide.eq(index).prepend('<div className="lg-video-cont" style="max-width:' + _this.s.iframeMaxWidth + '"><div className="lg-video"><iframe className="lg-object" frameborder="0" src="' + _src + '"  allowfullscreen="true"></iframe></div></div>');
            } else if (_hasPoster) {
                var videoClass = '';
    ...
    */
    Plugin.prototype.slide = function(index, fromTouch, fromThumb) {
        ...
        if (!_this.lgBusy) {
            ...
            if (!fromTouch) {
                ...
                // give 50 ms for browser to add/remove className
                setTimeout(function() {
    ...
    Plugin.prototype.touchEnd = function(distance) {
        ...
        // remove slide className once drag/swipe is completed if mode is not slide
        setTimeout(function() {
...
(function($, window, document, undefined) {
    ...
    Thumbnail.prototype.build = function() {
        ...
        function getThumb(src, thumb, index) {
            ...
            thumbList += '<div data-vimeo-id="' + vimeoId + '" className="lg-thumb-item" style="width:' + _this.core.s.thumbWidth + 'px; margin-right: ' + _this.core.s.thumbMargin + 'px"><img src="' + thumbImg + '" /></div>';
            vimeoId = '';
        }
        ...
        // manage active className for thumbnail
...
(function($, window, document, undefined) {
    ...
    Video.prototype.loadVideo = function(src, addClass, noposter, index, html) {
        ...
        if (isVideo.youtube) {
            ...
            video = '<iframe className="lg-video-object lg-vk ' + addClass + '" width="560" height="315" src="http://vk.com/video_ext.php?' + isVideo.vk[1] + a + '" frameborder="0" allowfullscreen></iframe>';
