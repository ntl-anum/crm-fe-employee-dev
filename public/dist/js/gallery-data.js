					...
					var attr_col = $(this).attr('data-col');
					 ...
					 if (winWidth >= 1466) {
						...
						$(this).find('.item').each(function () { 
							...
							$('.no-gutter .'+$(this).attr('className')).css( {
								width : postWidth  + 'px',
								height : 'auto',
								margin : 0 + 'px' 
							});
							$('.wide.'+$(this).attr('className')).css( { 
								width : postWidth * 2 - 20 + 'px'  
							});
							$('.no-gutter .wide.'+$(this).attr('className')).css( { 
								width : postWidth * 2 + 'px'  
							});
							$('.tall.'+$(this).attr('className')).css( {
								height : 'auto' 
							});
							$('.small.'+$(this).attr('className')).css( {
								height : 'auto',  
							});
						
							$('.no-gutter .tall.'+$(this).attr('className')).css( {
								height : 'auto', 
							});
							$('.wide-tall.'+$(this).attr('className')).css( {
								width : postWidth * 2 - 20 + 'px',
								height : postWidth * 2 - 20 + 'px'  
							});
							$('.no-gutter .wide-tall.'+$(this).attr('className')).css( {
								width : postWidth * 2 + 'px',
								height : 'auto', 
							});
						});
